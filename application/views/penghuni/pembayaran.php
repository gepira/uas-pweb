...
<div class="stats-row" style="grid-template-columns:repeat(3,1fr)">
  ...
  <div class="stat-box">
    ...
    <div class="stat-val" style="color:#1D9E75"><?= count(array_filter((array)$pembayaran, function($p) {
        return $p->status === 'Lunas';
    })) ?></div>
  </div>
  <div class="stat-box">
    <div class="stat-label">Pembayaran Pending</div>
    <div class="stat-val" style="color:#854F0B"><?= count(array_filter((array)$pembayaran, function($p) {
