...
<div class="stats-row" style="grid-template-columns:repeat(3,1fr)">
  ...
  <div class="stat-box">
    ...
    <div class="stat-val" style="color:#1D9E75"><?= count(array_filter((array)$detail, function($d) {
        return $d->status === 'Lunas';
    })) ?></div>
  </div>
  <div class="stat-box">
    <div class="stat-label">Transaksi Pending</div>
    <div class="stat-val" style="color:#854F0B"><?= count(array_filter((array)$detail, function($d) {
